        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="使用状态" prop="jiaoshiOrderTypes">
                        <el-select v-model="ruleForm.jiaoshiOrderTypes" :disabled="ro.jiaoshiOrderTypes" placeholder="请选择使用状态">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="使用状态" prop="jiaoshiOrderValue">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiaoshiOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiaoshiOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
